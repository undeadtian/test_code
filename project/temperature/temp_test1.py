...
class DrsuSSHConnectionTemp(DrsuSSHConnection):
    ...
    def get_xlwt_handle(self):
        ...
        self.sheet1.write(0, 1, 'camera1')
        self.sheet1.write(0, 2, 'radar')
        self.sheet1.write(0, 3, 'ai_out')
        self.sheet1.write(0, 4, 'cpu_tmp')
        self.sheet1.write(0, 5, 'gpu_tmp')
